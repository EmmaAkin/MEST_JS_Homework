 ...
 * 1. explain the special meaning of the following special characters
 ...
 \n new line
// This Character indicates a new line when the DOM is printing to screen

 \r carriage return

 // This is the character byte for new line it function exactly line \n althought in works differently in different browser,
 //it stands for space in some
 \v vertical tab
 This creates a vertical tab when printing tabeles
 \t
 \backspace
 ...
 This create a space betweent he new line
 */
 ...
 */
arr2.concat(arr1); //['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday']
 ...
 */
arr3.concat(arr1, arr2); //['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday']
...
var namer = person1.namer

var theNamer = namer.bind(person1);
theNamer(); // 81

var theNamer1 = namer.bind(person2);
theNamer1();
/*
...
hello.call(person2, 'Good Evening');
...
function capitalize (str) {
     ...
     words.forEach (function (word) {
            array = word.charAt(0).toUpperCase() + word.substr(1).toLowerCase();
            camelCase.push(array); //return an array of the words in Title Case
     });
